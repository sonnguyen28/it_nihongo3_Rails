...
class KanjisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kanji" do
    assert_difference('Kanji.count') do
      post kanjis_url, params: { kanji: { description: @kanji.description, kanji: @kanji.kanji, kun: @kanji.kun, on: @kanji.on } }
    end
  ...
  test "should update kanji" do
    patch kanji_url(@kanji), params: { kanji: { description: @kanji.description, kanji: @kanji.kanji, kun: @kanji.kun, on: @kanji.on } }
